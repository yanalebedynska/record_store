...
from rest_framework.response import Response  #Використовується для формування HTTP-відповідей
from rest_framework.decorators import action   #Декоратор для визначення нестандартних дій у ViewSet
